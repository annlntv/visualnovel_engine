...
namespace CHARACTERS
{
    public class CharacterManager : MonoBehaviour
    {
        ...
        public string characterRootPath => $"Characters/{CHARACTER_NAME_ID}";
        public string characterPrefabName => $"Character - [{CHARACTER_NAME_ID}]";
        public string characterPrefabPath => $"{characterRootPath}/{characterPrefabName}";
        ...
        public void SortCharacters(string[] characterNames)
        {
            ...
            List<Character> remainingCharacters = characters.Values
                .Except(sortedCharacters).OrderBy(character => character.priority).ToList();
